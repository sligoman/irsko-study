  ...
  <div class="layout-container layout-section">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <main class="lg:col-span-2">
        <h1 class="type-display-xl mb-4 text-brand-dark-green">Naše služby</h1>
        ...
        <section class="mb-8 bg-gray-50 p-6 rounded-lg">
          <h2 class="type-display-md mb-3 text-brand-dark-green">Jak probíhá spolupráce krok za krokem</h2>
          ...
          <div class="space-y-6 text-gray-700">
            <div>
              <h3 class="type-display-sm font-semibold text-brand-dark-green">Úvodní konzultace — poznáváme se a plánujeme</h3>
            ...
            <div>
              <h3 class="type-display-sm font-semibold text-brand-dark-green">Výběr oboru a univerzity</h3>
            ...
            <div>
              <h3 class="type-display-sm font-semibold text-brand-dark-green">Překlady a příprava dokumentů</h3>
            ...
            <div>
              <h3 class="type-display-sm font-semibold text-brand-dark-green">Vyplnění přihlášky a formality</h3>
            ...
            <div>
              <h3 class="type-display-sm font-semibold text-brand-dark-green">Praktická příprava před odjezdem</h3>
            ...
            <div>
              <h3 class="type-display-sm font-semibold text-brand-dark-green">Podpora po příjezdu</h3>
        ...
        {{-- <section class="mb-8">
          <h2 class="type-display-md mb-3 text-brand-dark-green">Naše balíčky</h2>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-brand-light-gray p-8 rounded-[12px] shadow">
              <h3 class="type-display-sm font-semibold text-xl mb-2 text-brand-dark-green">Balíček START</h3>
              ...
              <a href="{{ route('contact') }}" class="inline-block px-4 py-2 bg-[color:var(--color-brand-light-green)] text-white rounded">Zjistit více / objednat</a>
            </div>

            <div class="bg-brand-light-gray p-8 rounded-[12px] shadow">
              <h3 class="type-display-sm font-semibold text-xl mb-2 text-brand-dark-green">Balíček PREMIUM</h3>
              ...
              <a href="{{ route('contact') }}" class="inline-block px-4 py-2 bg-[color:var(--color-brand-light-green)] text-white rounded">Objednat PREMIUM</a>
            </div>
          </div>
        </section> --}}

        <section>
          <h2 class="type-display-md mb-3 text-brand-dark-green">Na čem si zakládáme</h2>
      ...
      <aside class="space-y-6">
        <div class="bg-brand-light-gray p-8 rounded-[12px] shadow">
          ...
          <a href="{{ route('contact') }}" class="inline-block px-4 py-2 bg-[color:var(--color-brand-light-green)] text-white rounded">Domluv konzultaci</a>
        </div>

        <div class="bg-brand-light-gray p-8 rounded-[12px] shadow">
          <h4 class="font-semibold mb-2">Co tě zajímá</h4>
          <p class="text-gray-600">Máte otázky ohledně studia, pojištění nebo ubytování? Podívejte se na <a href="{{ route('faq') }}" class="text-[color:var(--color-brand-light-green)]">nejčastější dotazy</a> nebo nám napište.</p>
        </div>
